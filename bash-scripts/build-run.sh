...
echo "2/4 Performing quiet maven build with 'mvn --quiet clean install'..."
source ./bash-scripts/build.sh

echo "3/4 Starting 3 Automodera instances..."
...
echo "4/4 All nodes have been started. Press CTRL + C to shut them down. If the process exits on its own, all nodes terminated likely due to an error. See the the log folder for more info."
