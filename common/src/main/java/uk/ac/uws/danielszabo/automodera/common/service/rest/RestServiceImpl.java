...
public class RestServiceImpl implements RestService {
    ...
    // TODO move all this configurable and move it to a constants class that can also connect to controllers and spring security config
    ...
    public boolean requestCertificateVerification(NodeCertificate certificate)
        ...
        ResponseEntity response =
                postAsXML(certificate.getIssuer().getHost(), WebPaths.CERTVERIFY_PATH, certificate, Message.class);
        if (response != null) {
    ...
    @Override
    public List<Collection> requestRepertoire(String host)
            throws TargetNodeUnreachableException {
    ...
    @Override
    public List<String> requestAllIntegratorAddresses(String host) throws TargetNodeUnreachableException {
        ResponseEntity response = null;
