...
public class NetworkServiceImpl implements NetworkService {
     ...
     *  then we check our local database, otherwise we request confirmation from the issuer.
    ...
    @Override
    public CertificateRequest certificateRequest(String origin, Node localNode) throws TargetNodeUnreachableException {
    ...
    @Override
    public void sendCollectionRepertoireToIntegrator(List<Collection> collectionList, String subscriberHost) throws TargetNodeUnreachableException {
        restService.sendCollectionRepertoireToIntegrator(collectionList, subscriberHost);
    }

    /**
     * Tries to update local archive repository
     * from operator node, if fails it will use
     * the local repository list cache.
     * <p>
     * It downloads only the addresses from the operator,
     * the actual node info will be fetched from archives directly.
     *
    ...
    /**
     * Tries to update local integrator repository
     * from operator node, if fails it will use
     * the local repository list cache.
     * <p>
     * It downloads only the addresses from the operator,
     * the actual node info will be fetched from integrators directly.
     *
    ...
    @Override
    public NetworkConfiguration fetchNetworkConfigurationAndSave(String originHost) throws TargetNodeUnreachableException {
    ...
    @Override
    public NetworkConfiguration fetchNetworkConfiguration(String originHost) throws TargetNodeUnreachableException {
